...
The number of new daily new cases relative to total active cases I = Confirmed-Dead-Recovered. Under the assumption of a approximately constant number of Susceptibles, this ratio corresponds to the parameter beta in the standard * <a href="https://en.wikipedia.org/wiki/Compartmental_models_in_epidemiology">SIR model</a>.
