...
Daily confirmed cases for the last 31 days. Time 0 indicates "Today" or rather the last available time point. The solid line is computed using a simple loess smoother.
...
### Daily cases - Deaths
Daily deaths for the last 31 days. Time 0 indicates "Today" or rather the last available time point. The solid line is computed using a simple loess smoother.
